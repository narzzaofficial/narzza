    ...
    <div className="space-y-6">
      ...
      <form onSubmit={submit} className="space-y-4">
          ...
          <div className="space-y-4">
            ...
            <label className="block">
              ...
              <textarea
                ...
                placeholder="Ceritakan bug yang kamu temukan. Apa yang terjadi? Di halaman mana?"
                required
              />
            </label>
          </div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full rounded-2xl bg-rose-700 py-3.5 text-sm font-bold text-white transition hover:bg-rose-600 disabled:opacity-50"
        >
